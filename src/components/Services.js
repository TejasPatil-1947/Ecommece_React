    ...
    return (
        <>
            ...
            <div style={{ display: "flex", justifyContent: "center" }}>
                <div style={{ margin: 100, display: "flex", width: 500, backgroundColor: "rgba(109, 60, 121, 0.52)", justifyContent: "center", alignItems: "center", boxShadow: '3px 3px 10px', padding: 30 }}>
                        ...
                        <input className="input-group-text"
                            {...register("fname", {
                                minLength: {
                                    ...
                                    value: 15,
                                    message: 'maximun length should be less than 15'
                                }
                            })}
